...
const Index: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-screen bg-gradient-to-br from-gray-900 to-wood-dark overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex items-center">
          <div className="max-w-3xl text-white">
            ...
            >
              Exceptional craftsmanship meets innovative design in our premium plywood products.
            </motion.p>
            <motion.div 
      ...
      {/* Features Section */}
      <section id="features" className="py-24 bg-gradient-to-br from-earth-beige to-earth-tan/70">
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
              Why Choose <span className="text-wood-dark">Shreeji Marketing</span>
            </h2>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <AnimatedSection animation="slide-right" className="md:pr-8">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Shreeji Marketing began with a simple vision: to sell the finest quality plywood that meets the demands of modern design while honoring traditional craftsmanship.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                Today, we supply premium plywood products to architects, designers, and craftsmen worldwide, helping bring their creative visions to life.
              </p>
              <Link 
                to="/products"
            ...
            <div className="hidden md:block" /> {/* Spacer for right column with background image */}
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover our most popular plywood solutions, selected for their exceptional quality and versatility.
            </p>
          </AnimatedSection>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProducts.map((product, index) => (
              <AnimatedSection key={product.id} delay={index * 200} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md hover-lift">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-wood-dark mb-2">{product.title}</h3>
...
const features = [
  {
    ...
    description: "Our plywood is crafted from the finest materials, ensuring durability and a superior finish for all your projects.",
    icon: (
  ...
  },
  {
    ...
    description: "We are committed to environmentally responsible forestry practices, using only sustainably sourced wood.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: "Our team of skilled artisans brings decades of experience to create plywood that meets the highest standards.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
...
const featuredProducts = [
  ...
  },
  {
    ...
    description: "Specially treated plywood designed for marine environments and outdoor use.",
    imageUrl: "/product-marine.jpg",
  },
  {
    id: 3,
    title: "Designer Walnut Veneer",
    description: "Luxury walnut veneered plywood for premium furniture and interior design.",
...
const testimonials = [
  {
    quote: "Shreeji Marketing provided us with exactly the quality of plywood we needed for our boutique hotel project. Their attention to quality is unmatched.",
    name: "Niraj Chopra",
    role: "Interior Designer",
  },
  {
    quote: "Working with sustainable materials was important for our eco-friendly cafe. Shreeji Marketing delivered not only on sustainability but also on best Material.",
    name: "Yash Rathod",
    role: "Architect",
  },
  {
    quote: "As a furniture maker, the quality of plywood and other materials are crucial to my work. Shreeji Marketing consistently provides the best materials with perfect finishes.",
    name: "Jiya Patel",
    role: "Customer",
  },
];
